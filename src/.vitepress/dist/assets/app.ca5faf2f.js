...
const ma = { key: 0, id: 'ads-container' },
  _a = le({
    setup(e) {
      const t = Bo(() => import('./Home.0679cf58.js')),
        n = () => null,
        s = n,
        r = n,
        i = n,
