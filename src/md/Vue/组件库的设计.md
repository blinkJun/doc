...
3. 为`example`创建一个容器组件`<Demo />`
  ...
  - 查看源代码、提供复制、查看仓库等功能
    ...
    - `SourceCode`：展示源代码
      ...
      <<< @/assets/vuepress-component-docs/.vuepress/components/SourceCode.vue

    - `IconSourceCode`：源代码图标

      <<< @/assets/vuepress-component-docs/.vuepress/components/IconSourceCode.vue

    - `IconGitlab`：`gitlab`图标

      <<< @/assets/vuepress-component-docs/.vuepress/components/IconGitlab.vue

    - `IconCopy`：复制图标

      <<< @/assets/vuepress-component-docs/.vuepress/components/IconCopy.vue

    - `Example`：展示`example`

      <<< @/assets/vuepress-component-docs/.vuepress/components/Example.vue

    - `Demo`：主组件

      <<< @/assets/vuepress-component-docs/.vuepress/components/Demo.vue

      `utils/utils.js`：

      <<< @/assets/vuepress-component-docs/.vuepress/utils/utils.js
...
4. 自定义容器，在`md`文档中加载`Demo`组件。
    ...
    - `markdown-it`：
      ...
      <<< @/assets/vuepress-component-docs/.vuepress/plugins/markdown-it.js

    - `highlight`：

      <<< @/assets/vuepress-component-docs/.vuepress/plugins/highlight.js

    在`.vuepress/config.js`中使用插件：

    - `config`：

      <<< @/assets/vuepress-component-docs/.vuepress/config.js{11-13}
...
包裹一个`div`用于对表格样式进行定制：`.vuepress/styles/index.styl`
  ...
  <<< @/assets/vuepress-component-docs/.vuepress/styles/index.styl{css}
